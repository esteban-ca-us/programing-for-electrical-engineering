...
class P2_GRADES(P1_GRADES): 
	...
	def __init__(self, w, z):
		...
		output_file.write("P2_P2_P2: P2_GRADES CONSTRUCTOR.\n")
	...
	def P2_SORT(self, x):
		...
		output_file.write("P2_P2_P2: START P2_SORT\n")
		if(x == 0):
			self.P1_LIST(1)
		elif(x == 1):
			...
			output_file.write("P2_P2_P2: STUDENTS ARE SORTED BASED ON IDS:\n")
			self.P0_LIST(1)
		else:
			output_file.write("P2_P2_P2: INPUT ERROR\n")
		output_file.write("P2_P2_P2: END P2_SORT\n")
	...
	def P2_REPORT(self, x, y, z):
		...
		//cout << "x " << x << " y " << y << " z " << z << " return_value = " << return_value << endl;
			...
			{
				ret_grade = grades[return_value][z];
				o_f << "P2_P2_P2: STUDENT " << x << " GRADE FOR EXAM " << z << " IS " << ret_grade << "." << endl;
				o_f << "P2_P2_P2: END P2_REPORT" << endl;
				return return_value;
			}
		}
		'''
		output_file.write("P2_P2_P2: START P2_REPORT\n") 
		return_value = self.P1_FIND(x, y)
		if (return_value == -2 or x <0 or x > 9999 or y < 0 or y > 999  or z < 0 or z >= self.e):
			output_file.write("P2_P2_P2: INPUT ERROR.\n") 
			output_file.write("P2_P2_P2: END P2_REPORT\n") 
			return -2
		elif (return_value == -1):
			output_file.write(f"P2_P2_P2: NO SUCH STUDENT WITH ID {x} .\n")
			output_file.write("P2_P2_P2: END P2_REPORT\n")
			return -1
		else:
			ret_grade = self.grades[return_value][z];
			output_file.write(f"P2_P2_P2: STUDENT {x} GRADE FOR EXAM {z} IS {ret_grade}.\n")
			output_file.write("P2_P2_P2: END P2_REPORT\n")
			return return_value
